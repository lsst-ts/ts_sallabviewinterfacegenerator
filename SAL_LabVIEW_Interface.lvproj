...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Directory" Type="Folder">
			<Item Name="Directory.lvclass" Type="LVClass" URL="../Directory/Directory.lvclass"/>
		</Item>
		<Item Name="Instances" Type="Folder">
			<Item Name="CloseConnectionInstance.lvclass" Type="LVClass" URL="../CloseConnectionInstance/CloseConnectionInstance.lvclass"/>
			<Item Name="OpenConnectionInstance.lvclass" Type="LVClass" URL="../OpenConnectionInstance/OpenConnectionInstance.lvclass"/>
			<Item Name="ReadValueInstance.lvclass" Type="LVClass" URL="../ReadValueInstance/ReadValueInstance.lvclass"/>
			<Item Name="WriteValueInstance.lvclass" Type="LVClass" URL="../WriteValueInstance/WriteValueInstance.lvclass"/>
		</Item>
		<Item Name="PolymorphicInstance" Type="Folder">
			<Item Name="PolymorphicInstance.lvclass" Type="LVClass" URL="../PolymorphicInstance/PolymorphicInstance.lvclass"/>
		</Item>
		<Item Name="PolymorphicStructure" Type="Folder">
			<Item Name="PolymorphicStructure.lvclass" Type="LVClass" URL="../PolymorphicStructure/PolymorphicStructure.lvclass"/>
		</Item>
		<Item Name="SALTypedefs" Type="Folder">
			<Item Name="Control 1.ctl" Type="VI" URL="../SALTypedefs/Control 1.ctl"/>
			<Item Name="Control 2.ctl" Type="VI" URL="../SALTypedefs/Control 2.ctl"/>
		</Item>
		<Item Name="Templates" Type="Folder">
			<Item Name="openConnection.vit" Type="VI" URL="../Templates/openConnection.vit"/>
		</Item>
		<Item Name="VirtualInstrument" Type="Folder">
			<Item Name="VirtualInstrument.lvclass" Type="LVClass" URL="../VirtualInstrument/VirtualInstrument.lvclass"/>
		</Item>
		<Item Name="salLabVIEWInterfaceMain.vi" Type="VI" URL="../salLabVIEWInterfaceMain.vi"/>
